...
var pokeImg;
  ...
  $("#startBtn").on("click", function start(){
    ...
    var queryURL3 = "https://pokeapi.co/api/v2/pokemon/gengar"
      ...
      //if($("#sprite").position().left == $("#cell36").position().left > 470 && $("#sprite").position().left == $("#cell36").position().left < 485  && document.getElementById("sprite").offsetTop > 470 && document.getElementById("cell36").offsetTop < 485){
          console.log("win");
